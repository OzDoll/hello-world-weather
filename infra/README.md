...
| Function App | `hello-world-weather-api` | Node 22, Functions v4, HTTP-only not enforced (`httpsOnly: false`, matching what's live — see Known gaps below). CORS allows `https://ozdoll.github.io` and `http://localhost:8000`. |
